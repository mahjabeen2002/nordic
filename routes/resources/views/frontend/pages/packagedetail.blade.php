...
<head>
  ...
  <meta property="og:image" content="http://growdigitalcare.com/uploads/package/{{ $fetch->image }}" />
  <meta property="og:url" content="http://growdigitalcare.com/packagedetail{{ $fetch->slug }}" />

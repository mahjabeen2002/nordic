                                            ...
                                            <td><img style="height:50px; width:50px;"
                                                    ...
                                                    <td>
                                                        ...
                                                        <div class="form-check form-switch">
                                                            <input class="form-check-input" type="checkbox" id="statusSwitch{{ $mediacenter->id }}"
                                                                   {{ $mediacenter->status === 'active' ? 'checked' : '' }}
                                                                   onchange="changeStatus({{ $mediacenter->id }}, this.checked)">
                                                        </div>
                                                    </td>
                                            <td>

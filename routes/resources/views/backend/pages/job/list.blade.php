                ...
                <div class="card">
                    ...
                    <div class="">
                        <a href="{{ route('jobs-create') }}" class="btn btn-success"
                            style="float: right; margin-top: -51px; margin-right: 41px;">Add Job</a>
                                ...
                                <tbody>
                                    @foreach ($jobs as $jobs)
                                        <tr>
                                            ...
                                            <!--<td>{!! html_entity_decode($jobs->details) !!}</td>-->

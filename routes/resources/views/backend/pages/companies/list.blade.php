                                ...
                                <tbody>
                                    @foreach ($companies as $companies)
                                        <tr>
                                            ...
                                            <td>{{ $companies->link }}</td>
                                           
                                            <td><img style="height:50px; width:50px;"
                                                    src="{{ asset('/uploads/Company/' . $companies->image) }}"
                                                    alt=""></td>
                                                   
                                            <td>
                                                <div style="display: flex; align-items: center;">
                                                    <a href="{{ route('collaboration-delete', ['id' => $companies->id]) }}"
                                                        onclick="confirmation(event)" style="margin-right: 10px;"><i
                                                            class="bi bi-trash" style="color: red;font-size:20px"></i></a>
                                                    <a href="{{ route('collaboration-edit', ['id' => $companies->id]) }}"><i

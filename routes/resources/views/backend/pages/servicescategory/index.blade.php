...
<div class="page-heading">
          ...
          <div class="col-12 col-md-6 order-md-2 order-first">
              <nav aria-label="breadcrumb" class="breadcrumb-header float-start float-lg-end">
                  <ol class="breadcrumb">
                      ...
                      <li class="breadcrumb-item active" aria-current="page">Service Category Table</li>
                  </ol>
              </nav>
          </div>
      </div>
  ...
  <section class="section">
      <div class="card">
          ...
          <div class="">
              <a href="{{ route('servicecategory-create') }}" class="btn btn-success"
                  style="float: right; margin-top: -51px; margin-right: 41px;">Add Service category</a>
                  ...
                  <table class="table table-striped" id="table1">
                      ...
                      <tbody>
                        @foreach($servicescategory as $category)
                              <tr>
                                  <td>{{ $category->name }}</td>
                                  <td><img style="height:50px; width:50px;" src="{{asset('/uploads/Servicecategory/'.$category->image)}}" alt=""></td>
                                  <td>
                                      <div style="display: flex; align-items: center;">
                                          <a href="{{ route('servicecategory-delete', ['id' => $category->id]) }}"
                                              onclick="confirmation(event)" style="margin-right: 10px;"><i
                                                  class="bi bi-trash" style="color: red;font-size:20px"></i></a>
                                          <a href="{{ route('servicecategory-edit', ['id' => $category->id]) }}"><i

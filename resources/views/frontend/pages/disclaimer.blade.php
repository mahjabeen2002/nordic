...
@endsection
@section('content')
<section class="page-header bg-grey" data-background="{{ asset('assets') }}/img/bg-img/page-header-bg.png">
    <div class="shapes">
        <div class="shape shape-1"><img src="{{ asset('assets') }}/img/shapes/page-header-shape-1.png" alt="">
        </div>
        <div class="shape shape-2"><img src="{{ asset('assets') }}/img/shapes/page-header-shape-2.png" alt="">
        </div>
        <div class="shape shape-3"><img src="{{ asset('assets') }}/img/shapes/page-header-shape-3.png" alt="">
        </div>
    </div>
        ...
        <div class="row align-items-center">
            <div class="col-lg-6">
                <div class="page-header-content">
                    ...
                    <h4 class="sub-title"><a href="/">Home </a><a href="/about_us" class="inner-page">/ Terms and Condition</a></h4>
                </div>
            </div>
        </div>
    </div>

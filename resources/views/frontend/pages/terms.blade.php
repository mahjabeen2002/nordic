...
@section('title')
    <title>Disclaimer | Grow Digital Care</title>
...
@section('content')
    ...
    <div class="page_header_default style_one">
        <div class="parallax_cover">
            <img src="{{ asset('assets') }}/images/page-header-default.jpg" alt="Disclaimers" class="cover-parallax">
        </div>
    ...
    <section class="terms-section pt-100 pb-100">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <div class="terms-content"><br>
                        <h2 class="main-title"><strong>Terms and Conditions</strong></h2>
 <p><strong>Last updated: August 21, 2024</strong></p>
                        ...
                        <div class="terms-group">
                            ...
                            <ul>
                                ...
                                <li><strong>Company</strong> (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to Nordic, Finlandsgatan 10, 164 74 Kista, Stockholm, Sweden.</li>
                                ...
                                <li><strong>Website</strong> refers to Nordic, accessible from https://nordic.example.com/</li>
                        ...
                        <!-- Continue with all other sections of the Privacy Policy -->
                        <div class="terms-group">
                        ...
                        <div class="terms-group">
                            ...
                            <ul>
                                <li>By email: info@nordicithub.com</li>
                                <li>By visiting this page on our website: www.nordic.example.com</li>
                            </ul>
                    </div>
                </div>
            </div>
    ...
    <style>
        ...
        /* Terms Content Styling - Left Aligned */
        .terms-section {
            background: #fff;
            line-height: 1.7;
            color: #555;
        ...
        .terms-content h3 {
            font-size: 22px;
            border-bottom: 2px solid #009c9d;
            padding-bottom: 8px;
